...
showToast(isMuted ? 'Sound effects muted' : 'Sound effects enabled ðŸ””', 'info');
});
});
}
...
<span style="font-size: 1.2rem; font-weight: 800; color: var(--primary);">â‚¹</span>
...
<button class="donation-chip" onclick="setDonationAmount(20, this)">â‚¹20</button>
<button class="donation-chip active" onclick="setDonationAmount(50, this)">â‚¹50</button>
<button class="donation-chip" onclick="setDonationAmount(100, this)">â‚¹100</button>
<button class="donation-chip" onclick="setDonationAmount(250, this)">â‚¹250</button>
<button class="donation-chip" onclick="setDonationAmount(500, this)">â‚¹500</button>
</div>
<!-- Dynamic QR Code -->
...
<h2 style="font-size: 1.35rem; font-weight: 900; margin-bottom: 10px; color: var(--text-primary);">${modalCfg.title || 'ðŸŽ‰ Welcome to AI Bots!'}</h2>
...
badge.textContent = 'ðŸ› ï¸ MAINTENANCE';
